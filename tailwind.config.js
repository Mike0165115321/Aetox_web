...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "fluid-h1": ["clamp(1.625rem, 4vw + 1rem, 4.5rem)",  { lineHeight: "1.1",  letterSpacing: "-0.02em", fontWeight: "700" }],
        "fluid-h2": ["clamp(1.5rem, 3vw + 1rem, 3rem)",    { lineHeight: "1.15", letterSpacing: "-0.01em", fontWeight: "600" }],
        "fluid-h3": ["clamp(1.125rem, 2vw + 1rem, 2rem)",    { lineHeight: "1.2",  fontWeight: "600" }],
        "fluid-h4": ["clamp(1rem, 1.5vw + 1rem, 1.5rem)", { lineHeight: "1.4", fontWeight: "500" }],
        "fluid-p":  ["clamp(0.9375rem, 1vw + 0.75rem, 1.125rem)", { lineHeight: "1.7",  fontWeight: "400" }],
        "fluid-sm": ["clamp(0.8125rem, 0.5vw + 0.75rem, 1rem)", { lineHeight: "1.6", fontWeight: "400" }],
        "fluid-label": ["0.7rem", { lineHeight: "1", fontWeight: "600", letterSpacing: "0.05em" }],
      },
      fontFamily: {
