...
import { ACADEMY_CATEGORIES } from '@/data/academy';
      ...
      <section className="py-24 relative z-10">
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
            ...
            >
              <GraduationCap className="w-4 h-4" /> AETOX Learning
            </motion.div>
            <motion.h1
            ...
            >
              แหล่งเรียนรู้ <br />
              <span className="text-deep-blue drop-shadow-deep-glow">Architecture & AI</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              เจาะลึกเบื้องหลังการสร้างระบบระดับ Production จากประสบการณ์จริงของ National AI Gold Medalist
            </motion.p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {ACADEMY_CATEGORIES.map((category, i) => (
              <motion.div
                key={category.id}
          ...
          >
             <h2 className="text-2xl font-bold text-white mb-4">กำลังเตรียมบทเรียน...</h2>
             <p className="text-gray-400">เรากำลังบันทึกวิดีโอและเตรียมเนื้อหาเชิงลึกกว่า 100 บทเรียน เพื่อให้คุณได้รับความรู้ที่ดีที่สุด</p>
          </motion.div>
        </div>
      </section>
