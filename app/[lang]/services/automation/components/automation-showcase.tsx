    ...
    (
      <div key="0" className="relative h-full flex flex-col items-center justify-center p-5 gap-2 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[240px] space-y-2">
          ...
          <div className="flex justify-between text-[7px] font-mono border-t border-white/5 pt-1.5"><span className="text-gray-600">{dict.labels.processedToday}</span><motion.span animate={{opacity:[0.7,1,0.7]}} transition={{duration:2,repeat:Infinity}} className="text-deep-blue font-black">98,240 {dict.labels.tasks}</motion.span></div>
        </div>
      </div>
    ),
      ...
      <div key="2" className="relative h-full flex flex-col items-center justify-center p-6 gap-4">
        <div className="w-full max-w-xs space-y-4">
          ...
          <div className="px-4 py-2.5 rounded-xl bg-deep-blue/5 border border-deep-blue/20 flex items-center justify-between">
            <span className="text-[8px] text-gray-400">{dict.benchmark.savedHours}</span>
            <motion.span animate={{opacity:[0.7,1,0.7]}} transition={{duration:2,repeat:Infinity}} className="text-xl font-black text-deep-blue">340h<span className="text-[9px] text-gray-500 ml-1">/{dict.labels.monthLabel}</span></motion.span>
          </div>
          <div className="flex items-center justify-center gap-2"><TrendingUp className="w-3.5 h-3.5 text-deep-blue"/><span className="text-[8px] text-gray-400">{dict.benchmark.speedX}</span><span className="text-[8px] font-black text-deep-blue">300 {dict.unitTimes}</span></div>
        </div>
      </div>
    ),
      ...
      <div key="3" className="relative h-full flex flex-col items-center justify-center p-6 gap-3">
        <div className="w-full max-w-xs space-y-3">
          ...
          <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 space-y-2">
            ...
            <div className="text-[6px] text-gray-600 font-mono">Manual task average error rate</div>
          </div>
          ...
          <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-green-500/5 border border-green-500/15 text-[7px]"><span className="text-gray-500">Error cost reduction</span><span className="text-green-400 font-black">-99.99%</span></div>
        </div>
      </div>
    ),
    ...
    (
      <div key="4" className="relative h-full flex flex-col items-center justify-center p-6 gap-4">
        <div className="w-full max-w-xs space-y-4">
          ...
          <div className="px-3 py-2 rounded-xl bg-deep-blue/5 border border-deep-blue/15 text-center text-[7px]"><span className="text-gray-500">{dict.benchmark.savedHours} </span><span className="font-black text-deep-blue">340 {dict.unitTime}</span><span className="text-gray-500"> /{dict.labels.monthLabel}</span></div>
        </div>
      </div>
    ),
  ];
