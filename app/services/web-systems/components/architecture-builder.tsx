...
export default function ArchitectureBuilder() {
  ...
  return (
    <div className="w-full glass-card rounded-[24px] border border-white/10 shadow-2xl overflow-hidden bg-black/40">
      ...
      <div className="relative p-6 md:p-10 min-h-[520px] flex flex-col bg-gradient-to-b from-transparent to-black/20">
        ...
        {/* 4. Business Impact Overlay (Moved to top-down flow) */}
        ...
        {/* 3. Layer Stack (Pushed down slightly) */}
