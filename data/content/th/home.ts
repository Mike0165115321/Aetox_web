export const homeContent = {
  ...
  founder: {
    ...
    accolade: "เหรียญทอง AI ระดับชาติ 2025",
    description: "นักพัฒนาที่สร้างระบบ AI ที่แก้ปัญหาได้จริง \n\n จากประสบการณ์ การเป็นหัวหน้าโปรเจคในการพัฒนาและออกแบบระบบ Ai & database ที่ทำงานร่วมกับหุ่นยนต์ประชาสัมพันธ์ระดับชาติ ไปจนถึง Open Source ที่เปิดให้นักพัฒนาทั่วโลกนำไปใช้งาน ทุกอย่างที่ผมสร้างมีเป้าหมายเดียว: แก้ปัญหา และสร้างผลลัพธ์ที่วัดได้"
  },
  recognition: "ผลงานที่พิสูจน์ได้",
  portfolio: "โปรเจคที่ใช้งานได้จริง",
  viewFull: "ดูทั้งหมด",
  standards: [
    "Open Source ที่มี Star, Fork และผู้ใช้งานจริง",
    "ระบบ AI ที่ Deploy ใช้งานจริงในระดับชาติ",
    "ออกแบบเพื่อแก้ปัญหาจริง ไม่ใช่แค่ Demo"
  ],
  values: [
    {
      title: "สร้างของจริง ไม่ใช่แค่ Concept",
      desc: "ทุกระบบที่ออกแบบต้องใช้งานได้จริง วัดผลได้จริง"
    },
    {
      title: "วิศวกรรมที่เน้นผลลัพธ์ (ROI-Driven Engineering)",
      desc: "ไม่สร้างเพื่อความสวยงาม แต่สร้างเพื่อให้ธุรกิจทำกำไรได้มากขึ้น"
    }
  ]
},
  engagement: {
