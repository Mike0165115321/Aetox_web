...
export const bookmind: ExtendedProject = {
  id: 'bookmind',
  title: 'BookMind: สถาปนิกฐานความรู้อัจฉริยะ (AI Knowledge Architect)',
  ...
  client: 'โครงการโอเพนซอร์ส (Open Source)',
  year: '2026',
  slug: 'bookmind',
...
export const robotGuide: ExtendedProject = {
  id: 'robot-guide',
  title: 'AI Robot Guide: ปัญญาประดิษฐ์เชิงบริบท (Contextual Intelligence)',
  ...
  client: 'โครงการพอร์ตโฟลิโอ (Portfolio Project)',
  year: '2026',
  slug: 'ai-robot-guide',
...
export const treesBot: ExtendedProject = {
  id: 'trees-bot',
  title: 'Trees4 Bot: ระบบอัตโนมัติระดับอุตสาหกรรม (Industrial Automation)',
  description: 'โซลูชันระบบอัตโนมัติ (Automation) ระดับอุตสาหกรรมที่ออกแบบมาเพื่อจัดการงานซ้ำซ้อนด้วยความแม่นยำสูง ลดโอกาสเกิดข้อผิดพลาด (Error) จากมนุษย์ได้ 100%',
  category: 'execution',
  image: projectMedia.treesBot.cover,
  media: projectMedia.treesBot,
  tags: ['Automation', 'Bot Engineering', 'Workflow Efficiency'],
  client: 'ลูกค้าเอกชน (Private Client)',
  year: '2026',
  slug: 'trees4-bot',
...
export const aetoxWeb: ExtendedProject = {
  id: 'aetox-web',
  title: 'Aetox.dev: รากฐานระบบธุรกิจระดับสูง (High-End B2B Foundation)',
  description: 'สถาปัตยกรรมเว็บสมัยใหม่ที่เน้นความเร็วและดีไซน์ระดับพรีเมียม พัฒนาด้วย Next.js (App Router), TypeScript และ Tailwind CSS พร้อมโครงสร้างข้อมูลแบบโมดูลาร์ (Modular) ที่รองรับการขยายตัวระดับองค์กร',
  category: 'foundation',
  image: projectMedia.aetoxWeb.cover,
  media: projectMedia.aetoxWeb,
  tags: ['Next.js', 'TypeScript', 'Tailwind CSS', 'System Architecture'],
  client: 'โครงการส่วนตัว (Self-Project)',
  year: '2026',
