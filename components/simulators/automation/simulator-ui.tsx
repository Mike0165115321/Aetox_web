...
export function KpiCard({ 
  ...
  return (
    <div className={`p-4 sm:p-6 rounded-xl md:rounded-2xl border transition-all duration-500 min-h-[110px] md:min-h-[140px] flex flex-col justify-between relative group ${accent ? 'bg-aetox-accent-subtle border-aetox-accent/20 shadow-aetox-glow' : 'bg-aetox-surface-lowest/50 border-aetox-border hover:border-aetox-border-strong'}`}>
      ...
      <div>
        <p className="text-[10px] md:text-fluid-label text-aetox-text-muted font-bold mb-2 md:mb-3 tracking-wide">{label}</p>
