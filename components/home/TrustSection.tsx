...
export default function TrustSection({ dict, projects }: { dict: any, projects: any[] }) {
  ...
  // Debug: console.log('TrustSection dict:', Object.keys(dict));
  
  const trust = dict.trust || dict; // Fallback if dict is already trust
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-5 h-full">
            <motion.div
              ...
              className="glass-card relative p-6 md:p-10 rounded-[32px] md:rounded-[40px] border-aetox-border bg-aetox-surface/10 overflow-hidden flex flex-col h-full shadow-xl"
            >
              {/* Award Image - Feature */}
              <div className="mb-6 md:mb-8 relative h-36 md:h-48 w-full rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 group/award">
                <Image 
          ...
          <div className="lg:col-span-7 space-y-4 md:space-y-8">
            ...
            <motion.div
              ...
              className="flex flex-col glass-card p-1 rounded-[32px] md:rounded-[40px] border-aetox-border bg-black/20 overflow-hidden"
            >
