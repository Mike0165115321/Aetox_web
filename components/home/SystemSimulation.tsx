          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 relative z-10">
            {dict.steps.map((step: any, idx: number) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-[24px] bg-aetox-card-bg border border-aetox-border flex items-center justify-center mb-4 md:mb-6 group-hover:border-aetox-accent/50 transition-all duration-500 relative shadow-lg">
                    ...
                    {/* Step Number Badge */}
                    <div className="absolute -top-2 -right-2 w-5 h-5 md:w-6 md:h-6 rounded-lg bg-aetox-card-bg border border-aetox-border flex items-center justify-center text-[10px] md:text-xs font-black text-aetox-text-muted">
                      0{step.id}
                    </div>
                  </div>
