...
export default function SystemSimulation({ dict }: { dict: any }) {
  ...
  return (
    <section id="simulation" className="py-12 md:py-32 relative overflow-hidden scroll-mt-20">
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12 md:mb-24">
          <h2 className="text-fluid-h2 font-bold text-aetox-text-main tracking-tighter uppercase">
        ...
        <div className="relative max-w-5xl mx-auto">
          {/* Connection Lines removed for borderless pass */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 relative z-10">
            {dict.steps.map((step: any, idx: number) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-[24px] bg-aetox-card-bg flex items-center justify-center mb-4 md:mb-6 transition-all duration-500 relative shadow-lg">
                    ...
                    {/* Step Number Badge */}
                    <div className="absolute -top-2 -right-2 w-5 h-5 md:w-6 md:h-6 rounded-lg bg-aetox-card-bg flex items-center justify-center text-[10px] md:text-xs font-black text-aetox-text-muted">
                      0{step.id}
                    </div>
                  </div>
          ...
          <motion.div 
            ...
            className="mt-12 md:mt-20 p-6 md:p-8 aetox-card !rounded-[32px] bg-aetox-accent/[0.02] max-w-2xl mx-auto text-center shadow-xl"
          >
              <div className="px-4 py-2 rounded-full bg-aetox-accent/10 text-aetox-accent text-xs font-black mb-4">
                {dict.caseLabel}
              </div>
